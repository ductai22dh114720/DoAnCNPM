...
import calculalteAvgRating from "../components/Utils/avgRating";
...
const TourDetails = () => {
  ...
  //this is an staic data later we will call our API and load our data from database
  const tour = tourData.find((tour) => tour.id === id);

  // detructure properties from our object
  const {
    photo,
    title,
    desc,
                        ...
                        <div className="w-100">
                          <div className="d-flex align-items-center justify-content-between">
                            <div>
                              <h5>muhib</h5>
                              <p>
                                {new Date("01-07-2023").toLocaleDateString(
                                  "en-US",
                                  options
                                )}
                              </p>
